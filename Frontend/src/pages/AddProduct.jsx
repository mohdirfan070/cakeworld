...
export default function AddProduct() {
  ...
  let handleSubmit = async (e) => {
    if(inpData.name=="" || inpData.price=="" || inpData.Image=="" || inpData.description=="") {
      setRes(true);
    }else{
...
reset();
   ...
   return (
    ...
    <>
      ...
      <Navbar />
      <div className="border-neutral  p-12 mt-10 border-2 max-w-fit rounded-md m-auto min-h-max bg-ghost">
        <div className="hero-content flex-col lg:flex-row-reverse">
          <div className="relative">
            <h2 className="input mx-10 font-medium">Add Product</h2>
            { (response) ? <div role="alert" className="alert transition-all duration-1000 animate-pulse absolute top-[-6rem] alert-error">
        <svg
