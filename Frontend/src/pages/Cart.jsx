      ...
      <section className="mt-20 w-full ">
        <div className="main m-auto   w-full ">
          {(products.length!=0) ? (
            ...
            <>
             <Link to={"/products"}> <h2 className="text-center my-44"> <button className="btn bg-neutral-content btn-outline focus:bg-neutral focus:text-neutral-content text-sm w-56 rounded-md hover:rounded-full transition-colors duration-300 ease-in ">  Cart is Empty! <br />Click to add Items </button></h2></Link>
