...
<dialog id="my_modal_1" className="modal">
  <div className="modal-box">
    ...
    <p className="pt-2 "><span className="text-error font-medium">Note </span> : Order will arrive within <b> 4hours</b> of order confirmed with payment <br />Please write your number as messege for payments</p>
